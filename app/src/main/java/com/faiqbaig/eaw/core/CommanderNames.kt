...
object CommanderNames {
    val french = listOf("Dubois", "Leclerc", "Ney", "Davout", "Soult", "Lannes", "Murat", "Masséna", "Suchet", "Victor", "Oudinot", "MacDonald", "Marmont", "Moncey", "Mortier", "Jourdan", "Bernadotte", "Augereau", "Brune", "Bessières", "Kellermann", "Lefebvre", "Pérignon", "Sérurier", "Desaix", "Bélanger", "Olise", "Deschamps", "Rabiot", "Rampon", "Fabron", "De Grasse", "De Gaul", "Villeneuve", "Auboyneau", "Jourdan", "Moreau", "Berthier", "Junot", "La Harpe", "Rochambeau", "Dumouriez", "Lafayette", "Honoré", "Beauharnais", "Rapp", "")
    val british = listOf("Hill", "Simons", "Clinton", "Wellesley", "Moore", "Picton", "Beresford", "Crawford", "Paget", "Umbridge", "Somerset", "Ponsonby", "Cornwallis", "Pack", "Gage", "Colville", "Cole", "Howe", "Hope", "Graham", "Cotton", "Stewart", "Cunningham", "Fraser", "O'Hara", "Smith", "Swann", "Beckett", "Tarleton", "Montgomery", "Arnold", "Vian", "Mountbatten", "Murphy", "Jones", "O'Brien", "Williams", "Brown", "Wilson", "Walsh", "Doyle", "Jognson", "Turner", "O'Connor", "Scott", "Thompson", "Edwards", "Green", "Hall", "Harris", "Lewis", "Cooper", "Cromwell", "Percy", "Campbell", "French", "Collins")
